...
public class VideoEnabledWebChromeClient extends WebChromeClient implements OnPreparedListener, OnCompletionListener, OnErrorListener
{
     ...
     */
    public VideoEnabledWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView, VideoEnabledWebView webView, Context ctx)
    {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
        this.loadingView = loadingView;
    ...
    public void onShowCustomView(View view, final CustomViewCallback callback)
    {
        if (view instanceof FrameLayout)
        {
            ...
            js1 += "myurl1 = App.Collections.allarticles.get(window.location.hash.split('/')[1]).get('mp4');";
            ...
            if(focusedChild.getClass().getName().equals("android.webkit.HTML5VideoFullscreen$VideoTextureView")){
                ...
                activityVideoView.addView(videoViewContainer, layoutParams);
                ...
                else // Usually android.webkit.HTML5VideoFullScreen$VideoSurfaceView, sometimes android.webkit.HTML5VideoFullScreen$VideoTextureView
                {
                    ...
                    if (webView != null && webView.getSettings().getJavaScriptEnabled())
                    {
                        ...
                        js += "_ytrp_html5_video = $(\"source[src='\" + myurl1 + \"']\").parent()[0];";
                        js += "if (_ytrp_html5_video !== undefined) {";
                        {
                            js += "console.log(_ytrp_html5_video);";
